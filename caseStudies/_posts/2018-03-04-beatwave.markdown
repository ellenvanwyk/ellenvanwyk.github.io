...
<img class="design-feature" src= "https://ejvw.files.wordpress.com/2014/10/laptopdj.jpg" class = "displayed" style = "width:100%;height:auto">
<span>I drew all our storyboards and led the development.</span>
...
<span>My paper prototype known as the "Dual Grid" protoype.  Users map sound effects to the axes on the grids.  The user changes the amout of effect applied to the song using Leap where pinching is like clicking and an open hand is like hovering.  They transition between songs using the Mixer.</span>

<img src= "/assets/beatwave/leapMotionStoryBoard.png" class = "displayed" alt = "paper prototype" style = "width:100%;height:auto">
<span>A usage scenario for the predecessor to the Dual Grid; the single grid.</span>
<br>
<img src= "/assets/beatwave/3dshspes.jpg" class = "displayed bigImg" alt = "paper prototype" >

<span>A usage scenario for my teammate&rsquo;s prototype, the "BlobMaster".</span>
...
### Fun!
Ultimately DJs found Myo more fun than Leap. We hypothesize this was partially due the fact that Leap requires more visual feedback and concentration to stay within bounds of the screen.

### Minimize fatal flaws
Both Leap&rsquo;s calibration lag time and Myo&rsquo;s poor gesture recognition would seriously disrupt a performance. While we couldn&rsquo;t design around Leap&rsquo;s limitations, we could optimize Myo by avoiding unreliable gestures.
